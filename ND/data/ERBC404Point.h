...
#ifndef ERBC404Point_H
#define ERBC404Point_H
...
class ERBC404Point : public FairMCPoint 
{
 ...
 public:
  ...
  /** Copy constructor **/
  ERBC404Point(const ERBC404Point&);


  /** Destructor **/
  virtual ~ERBC404Point();


  ERBC404Point& operator=(const ERBC404Point&) { return *this; }
  ...
  Int_t HexNr() const {return fHexNr;}
