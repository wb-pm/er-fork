...
#include "ERFootMuSiGeoComponentPassive.h"

//--------------------------------------------------------------------------------
ERFootMuSiGeoComponentPassive::ERFootMuSiGeoComponentPassive(
...
//--------------------------------------------------------------------------------
void ERFootMuSiGeoComponentPassive::ConstructGeometryVolume() {
...
//--------------------------------------------------------------------------------
ClassImp(ERFootMuSiGeoComponentPassive)