...
ERFootMuSi -> ERTelescope renaming 
Also added methods ConstructGeometryVolume and ParseXmlParameters from ERQTelescopeGeoComponentSingleSi.cxx
*/
/********************************************************************************
...
void ERFootMuSiGeoComponentSingleSi::ConstructGeometryVolume(void) {
  ParseXmlParameters();
...
//--------------------------------------------------------------------------------------------------
void ERFootMuSiGeoComponentSingleSi::ParseXmlParameters() {
  TString xmlFile = ERFootMuSiSetup::Instance()->GetXMLParametersFile();
...
//--------------------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------------------
ERFootMuSiGeoComponentSingleSi::ERFootMuSiGeoComponentSingleSi(
    const TString& typeFromXML, const TString& id, const TString& orientAroundZ) 
: ERFootMuSiGeoComponentSensitive(typeFromXML, id)
{ 
...
: ERFootMuSiGeoComponentSensitive(typeFromXML, id, position, rotation)
{
  TString volumeNameInd = (orientAroundZ == "X") ? "_X" : "_Y";  
  fOrientAroundZ = (orientAroundZ == "X") ? OrientationAroundZ::X : OrientationAroundZ::Y;
  fVolumeName += volumeNameInd;
...
//--------------------------------------------------------------------------------------------------
TString ERFootMuSiGeoComponentSingleSi::GetBranchName(
...
//--------------------------------------------------------------------------------------------------
std::list<OrientationAroundZ> ERFootMuSiGeoComponentSingleSi::GetOrientationsAroundZ() const {
  return {fOrientAroundZ};
}
//--------------------------------------------------------------------------------------------------
std::list<ChannelSide> ERFootMuSiGeoComponentSingleSi::GetChannelSides() const {
...
//--------------------------------------------------------------------------------------------------
Int_t ERFootMuSiGeoComponentSingleSi::GetChannelFromSensitiveNodePath(
...
//--------------------------------------------------------------------------------------------------
ClassImp(ERFootMuSiGeoComponentSingleSi)
