...
void DrawingTwoSimOneExp(Int_t treeID1,Int_t treeID2, TString filename)
{
	tr1[treeID1]->Draw("GadastCsIDigi.fEdep*1000>>hWithoutLO(1000,0.,3000.)");
	h1[treeID1] = (TH1D*)gPad->GetPrimitive("hWithoutLO");
	...
	tr1[treeID2]->Draw("GadastCsIDigi.fEdep*1000>>hWithLO(1000,0.,3000.)", "", "Same");
	h1[treeID2] = (TH1D*)gPad->GetPrimitive("hWithLO");
	...
	legend->SetTextFont(72);
    legend->SetTextSize(0.03);
    legend->AddEntry(h1[treeID2], "Simulation (with #DeltaLO)", "l");
    legend->AddEntry(h1[treeID1], "Simulation (without #DeltaLO)", "l");
