...
//----------------------------------
  ...
  **/
  ...
  //-------- Set MC event header --------------------------------------------
  ER3Hto3HeEventHeader* decayMCheader = new ER3Hto3HeEventHeader();
  ...
  generator->SetBoxXYZ(0.0, 0.0, 0.0, 0.0, beamStartPosition);
...
/////////////////////////////////////////////////////////////////////////////
  ...
  ERDecay3Hto3He* targetDecay = new ERDecay3Hto3He();
